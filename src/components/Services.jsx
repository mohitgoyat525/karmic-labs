          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 rounded-xl">
            {SERCVICE_LIST.map((obj, i) => (
              <div key={i} className="relative z-20 bg-transparent group">
                ...
                <div className="border border-solid border-transparent transition-all ease-linear z-50 duration-200 relative bg-transparent hover:bg-white hover:bg-opacity-10 hover:backdrop-blur-[10px] rounded-xl w-full max-w-[364px] p-5 mx-auto">
