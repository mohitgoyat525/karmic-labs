    ...
    <div className="container pt-[136px] max-xl:pt-28 max-lg:pt-20 max-md:pt-14 max-sm:pt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20">
        {SERCVICE_LIST.map((obj, i) => (
          <div
                className={`border border-solid border-transparent transition-all ease-linear duration-200 hover:bg-light-gray rounded-xl w-full max-w-[364px] p-5 mx-auto`}
            key={i}
          >
