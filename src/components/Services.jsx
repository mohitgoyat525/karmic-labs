...
const Services = () => {
    return (
      <div id="services" className="relative">
        ...
        />
        <div className="container pt-[136px] max-xl:pt-36 max-lg:pt-20 max-md:pt-14 max-sm:pt-10 relative z-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 rounded-xl">
            {SERCVICE_LIST.map((obj, i) => (
              <div
                key={i}
                className="group mx-auto  transition-all ease-linear z-50 duration-200 relative bg-transparent rounded-xl w-full max-w-[364px]"
              >
                ...
                <div className="border border-solid border-transparent w-full transition-all duration-300 rounded-xl group-hover:bg-white group-hover:bg-opacity-10 group-hover:backdrop-blur-[10px]">
                  <div className="p-5">
