        ...
        <div className="container pt-[136px] max-xl:pt-36 max-lg:pt-20 max-md:pt-14 max-sm:pt-10">
          <div className="max-w-[570px] mx-auto relative">
            ...
            <img
              ...
              alt="borders"
              className=" absolute -top-3 max-xl:-top-9 left-16 max-lg:-top-9 max-sm:left-0 "
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 rounded-xl">
            {SERCVICE_LIST.map((obj, i) => (
              <div key={i} className="relative z-20 bg-transparent group">
                <div className="absolute size-[74px] rounded-full bg-white border border-solid border-white -top-6 -right-8 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="border border-solid border-transparent transition-all ease-linear z-50 duration-200 relative bg-transparent hover:custom-blur rounded-xl w-full max-w-[364px] p-5 mx-auto">
